...
<h1>
        <img src="/images/profile.jsp" style="border-radius: 70%; width: 40px; padding: 0px; margin: 0px; cursor: pointer;" onclick="location.href='/manager/calendar-week/${name}';"/>
        ...
        <tr>
                ...
                <c:choose>
                        ...
                        <c:choose>
                                ...
                                <c:otherwise>
                                <td valign="top" style="font-size: 10pt; line-height: 140%; background-color: #FAF9F6;" onclick="chgfocus('CAL.${yearInt}.${monthInt}.${col}')">
