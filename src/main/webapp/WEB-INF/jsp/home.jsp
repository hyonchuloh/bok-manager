...
<body>
    ...
    <p style="text-align: center;">
        <input type="button" value="달력" class="login-input" onclick="location.href='/manager/calendar';"/><br/>
        ...
        <input type="button" value="사용자관리" class="login-input" onclick="location.href='/admin/users';"/><br/>
    </p>   
</body>
</html>