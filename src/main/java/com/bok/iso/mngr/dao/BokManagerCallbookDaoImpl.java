...
public class BokManagerCallbookDaoImpl implements BokManagerCallbookDao {
    ...
    BokManagerCallbookDaoImpl(JdbcTemplate jdbcTemplate) {
    ...
    public void initTable() {
        ...
        logger.info("--- {}\n", sql.toString());
        logger.info("--- 연락처 DB 초기화(이미 존재하는 경우 무시) result=[{}]", jdbcTemplate.update(sql.toString())); 
    }

    @Override
    public List<BokManagerCallbookDto> selectItems() {
        StringBuffer sql = new StringBuffer("\n\n\t/* 전체 리스트 조회 쿼리*/");
        sql.append("\n\tSELECT SEQ, EXT_NAME, DEP_NAME, BIZ_NAME, NAME, CALL, EMAIL, EXT FROM BOK_MNGR_CALLBOOK ORDER BY EXT_NAME, DEP_NAME, BIZ_NAME, NAME");
        ...
        logger.info("--- {}\n", sql.toString());
        logger.info("--- 연락처 DB 전체 조회 RESULT CNT : " + retValue.size());
        return retValue;
    }
    ...
    public BokManagerCallbookDto selectItem(int seq) {
        ...
        logger.info("--- {}\n", sql.toString());
        logger.info("--- 연락처 DB 단건 조회 SEQ : " + seq);
    ...
    public int updateItem(BokManagerCallbookDto dto) {
        ...
        logger.info("--- {}\n", sql.toString());
        logger.info("--- 연락처 업데이트 PARAM : " + dto.toString());
        int result = jdbcTemplate.update(sql.toString(), dto.getExtName(), dto.getDepName(), dto.getBizName(), dto.getName(), dto.getCall(), dto.getEmail(), dto.getExt(), dto.getSeq());
        logger.info("--- 연락처 업데이트 RESULT : " + result);
        return result;
    }
    ...
    public int insertItem(BokManagerCallbookDto dto) {
        ...
        logger.info("--- {}\n", sql.toString());
        logger.info("--- 연락처 단건 추가 PARAM : " + dto.toString());
        int result = jdbcTemplate.update(sql.toString(), dto.getExtName(), dto.getDepName(), dto.getBizName(), dto.getName(), dto.getCall(), dto.getEmail(), dto.getExt());
        logger.info("--- 연락처 단건 추가 RESULT : " + result);
        return result;
    }
    ...
    public int deleteItem(int seq) {
        ...
        int result = jdbcTemplate.update(sql.toString(), seq);
        logger.info("--- 연락처 단건 삭제 RESULT : " + result);
        return result;
    }
